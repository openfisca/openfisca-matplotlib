...
def loop_over_year(xaxis="sali", maxrev=500000, filename=None):
    ...
    plt.legend(["Ann�e 2006", "Ann� 2007", "Ann�e 2008", "Ann�e 2009"],fancybox=True,loc=2,)
    plt.title("Taux d''imposition moyen des revenus",color="blue") 
#   plt.title(["Taux d''imposition moyen des revenus d''activit�s", "Taux d''imposition moyen des int�r�ts des revenus et des capitaux mobiliers n''ouvrant pas droit � abattement", "Taux d''imposition moyen des revenus des actions ouvrant droit � abattement", "Taux d''imposition moyen des revenus fonciers imposables", "Taux d''imposition moyen des autres revenus imposables (pr�retraite, ch�mage)"],color="blue")  
