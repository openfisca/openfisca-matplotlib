...
from src.qt.QtGui import QWidget, QHBoxLayout, QLabel
from src.qt.QtCore import QTimer, SIGNAL

# Local import
from src.core.baseconfig import _
from src.core.guiconfig import get_font
...
def test():
    from src.qt.QtGui import QMainWindow
