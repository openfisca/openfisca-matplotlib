...
from tunisie.data import InputTable
from tunisie.model import ModelTunisie
...
#            self._dataframe_widget.set_dataframe(self.survey.table)
    ...
    def refresh_bareme(self):
        ...
        population_courant = SystemSf(ModelTunisie, P_courant, P_default)
        population_courant.set_inputs(input_table)
        data_courant = gen_output_data(population_courant)

        if self.reforme:
            population_default = SystemSf(ModelTunisie, P_default, P_default)
    ...
    def compute_aggregate(self):
        ...
        output_table = SystemSf(ModelTunisie, P_courant, P_default)
